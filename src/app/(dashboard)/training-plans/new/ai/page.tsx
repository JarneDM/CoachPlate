...
import AITrainingPlanGenerator from "@/components/training-plans/AITrainingPlanGenerator";

export default async function AITrainingPlanPage() {
  ...
  return (
    <div className="max-w-3xl mx-auto">
      ...
      <div className="mb-8">
        <h1 className="text-2xl font-bold text-gray-900">AI trainingsschema generator</h1>
        <p className="text-gray-400 text-sm mt-1">
          Kies een klant en AI genereert automatisch trainingsdagen en oefeningen op basis van doelen en voorkeuren.
        </p>
      </div>
      ...
      {clients.length === 0 ? (
        <div className="text-center py-16 bg-white rounded-xl border border-gray-100">
          ...
          <p className="text-gray-400 text-sm mb-6">Voeg eerst een klant toe voor je een schema genereert.</p>
          <Link
            href="/clients/add"
        ...
        <AITrainingPlanGenerator clients={clients} />
      )}
    </div>
  );
}
