    ...
    <div className="max-w-5xl mx-auto">
      ...
      {recipes.length > 0 ? (
            ...
            <div key={recipe.id} className="bg-white rounded-xl border border-gray-100 p-5 hover:border-green-200 transition-colors">
              <div className="flex items-start justify-between mb-3">
                <div className="flex-1">
                  ...
                  <div className="flex items-center gap-2 mt-1">
                    ...
                    {recipe.prep_time_min && <span className="text-xs text-gray-400 flex gap-1"><Timer className="w-4 h-4" /> {recipe.prep_time_min} min</span>}
                  </div>
                </div>
              ...
              {recipe.calories && (
                <div className="grid grid-cols-4 gap-2 mb-4">
                  ...
                  <MacroBadge label="prot" value={recipe.protein_g} color="blue" />
        ...
        <div className="text-center py-24 bg-white rounded-xl border border-gray-100">
          <div className="text-5xl mb-4 flex justify-center items-center"><ChefHat className="w-12 h-12 text-gray-300" /></div>
