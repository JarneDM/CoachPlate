    ...
    <main className="min-h-screen bg-gray-50 py-10 px-4">
      <div className="max-w-3xl mx-auto bg-white border border-gray-100 rounded-2xl p-6 md:p-8">
        ...
        <div className="prose prose-sm max-w-none mt-6 text-gray-700">
          <p>
            Deze Algemene Voorwaarden zijn van toepassing op het gebruik van CoachPlate, aangeboden door Jarne De Meyer, Sint-Niklaas,
            België (hierna &quot;CoachPlate&quot;).
          </p>

          <h2>Artikel 1 — Definities</h2>
          <ul>
            <li>
              <strong>CoachPlate:</strong> het online platform beschikbaar via coachplate.app
            </li>
            <li>
              <strong>Gebruiker:</strong> elke coach, trainer of professional die een account aanmaakt
            </li>
            <li>
              <strong>Klant:</strong> de eindgebruiker wiens gegevens door de coach worden beheerd
            </li>
            <li>
              <strong>Dienst:</strong> alle functionaliteiten aangeboden via het platform
            </li>
          </ul>

          <h2>Artikel 2 — Toepasselijkheid</h2>
          <p>
            Door een account aan te maken en gebruik te maken van CoachPlate, aanvaard je deze Algemene Voorwaarden volledig. Als je niet
            akkoord gaat, kan je geen gebruik maken van de dienst.
          </p>
          ...
          <ul>
            <li>
              <strong>Starter:</strong> beperkt aantal klanten, basisfunctionaliteiten
            </li>
            <li>
              <strong>Pro:</strong> onbeperkt klanten, AI-functies, volledige toegang
            </li>
            <li>
              <strong>Studio:</strong> voor gyms en grotere organisaties, op aanvraag
            </li>
          </ul>
          <h3>3.2 Prijzen</h3>
          <p>
            De actuele prijzen zijn beschikbaar op de website. Prijzen kunnen worden aangepast. Bestaande klanten worden minstens 30 dagen
            op voorhand verwittigd van prijswijzigingen.
          </p>
          <h3>3.3 Betaling</h3>
          <p>
            Betalingen verlopen via Stripe. Abonnementen worden maandelijks automatisch verlengd. Bij mislukte betaling behoudt CoachPlate
            het recht om de toegang tijdelijk te beperken.
          </p>
          ...
          <p>
            Alle rechten op het platform, inclusief software, ontwerp, logo&apos;s en content, zijn eigendom van CoachPlate. De gegevens die
            gebruikers invoeren blijven eigendom van de gebruiker. CoachPlate heeft uitsluitend een licentie om deze te verwerken voor het
            leveren van de dienst.
          </p>

          <h2>Artikel 7 — Beschikbaarheid en onderhoud</h2>
          <p>
            Wij streven naar een beschikbaarheid van 99,5% maar kunnen geen absolute garantie bieden. Gepland onderhoud wordt vooraf
            gecommuniceerd.
          </p>
          ...
          <p>
            Onze totale aansprakelijkheid is in alle gevallen beperkt tot het bedrag dat de gebruiker de voorbije 3 maanden heeft betaald
            voor de dienst.
          </p>
          ...
          <p>
            Je kan je abonnement op elk moment opzeggen via de instellingenpagina. Je behoudt toegang tot het einde van de betaalde periode.
            Er is geen terugbetaling voor niet-gebruikte periodes.
          </p>
          <h3>9.2 Door CoachPlate</h3>
          <p>
            Wij kunnen een account opschorten of beëindigen bij ernstige schending van deze voorwaarden, na voorafgaande kennisgeving tenzij
            de schending een onmiddellijke reactie vereist.
          </p>

          <h2>Artikel 10 — Wijzigingen</h2>
          <p>
            Wij behouden het recht om deze voorwaarden te wijzigen. Gebruikers worden minstens 30 dagen op voorhand verwittigd via e-mail.
            Voortgezet gebruik na de ingangsdatum geldt als aanvaarding van de nieuwe voorwaarden.
          </p>
