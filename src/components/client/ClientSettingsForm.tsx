...
export default function ClientSettingsForm({ client }: Props) {
  ...
  async function handleCodeChange() {
    const result = await changeCoach({ coach_id: coachCode });
    ...
    <div>
      <form onSubmit={handleSubmit} className="space-y-5">
        ...
        <div className="bg-white rounded-xl border border-gray-100 p-5 shadow-sm">
          <SectionHeader icon={<User size={15} />} title="Persoonlijke gegevens" description="Je naam en contactgegevens" />
        ...
        <div className="bg-white rounded-xl border border-gray-100 p-5 shadow-sm">
          <SectionHeader icon={<Weight size={15} />} title="Lichaamsgegevens" description="Je coach gebruikt deze info voor je plannen" />
        ...
        <div className="bg-white rounded-xl border border-gray-100 p-5 shadow-sm">
          <SectionHeader icon={<Target size={15} />} title="Doelen & voorkeuren" description="Wat wil je bereiken?" />
      ...
      <div className="border-t-2 border-t-black">
        ...
        <input
          type="text"
          placeholder="Coach Code van de nieuwe coach"
          className={input}
          value={coachCode}
          required
      ...
      <div className="mt-5 border-t border-gray-200 pt-5">
        <p className="text-sm text-gray-500">Wil je jouw account verwijderen? Neem contact op met je coach.</p>
      </div>
    </div>
  );
}
